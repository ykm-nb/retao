                    ...
                    <div class="layer shopType">
                        ...
                        <div class="right">
                            <div class="right-left">
                                <div class="slider">
                                    <button class="btn-left" :style="{'left': (sliderIndex1 * 42) + 'px'}">{{ sliderList[sliderIndex1] }}</button>
                                    <button class="btn-right" :style="{'left': (sliderIndex2 * 42) + 'px'}">{{ sliderList[sliderIndex2] }}</button>
                                </div>
                                <img src="./type2.png">
                            </div>
